...
[tableInfo.incrementColumnId]({{ site.baseurl }}ref/ref_home.html#webdataconnectorapi.tableinfo-1.incrementcolumnid)
property on the tableInfo object for that table as defined in your
[getSchema]({{ site.baseurl }}ref/ref_home.html#webdataconnectorapi.webdataconnector.getschema) function.
...
a value in the [table.incrementValue]({{ site.baseurl }}ref/ref_home.html#webdataconnectorapi.table.incrementvalue)
